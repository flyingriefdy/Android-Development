...
public class GetFlickrJsonData extends GetRawData {
    ...
    public void execute() {
        super.setmRawUrl(mDestionationUri.toString());
        DownloadJsonData downloadJsonData = new DownloadJsonData();
        Log.v(LOG_TAG,"Built URI = "+mDestionationUri.toString());
        downloadJsonData.execute(mDestionationUri.toString());
    }
    ...
    public boolean createAndUpdateUri(String searchCriteria, boolean matchAll) {
        ...
        mDestionationUri = Uri.parse(FLICKR_API_BASE_URL).buildUpon()
    ...
    public void processResult() {
        ...
        try {
            ...
            for (int i = 0; i < itemsArray.length(); i++) {
                ...
                this.getmPhotos().add(photoObject);
            }

            for (Photo singlePhoto : getmPhotos()) {
    ...
    public class DownloadJsonData extends DownloadRawData {
        ...
        protected String doInBackground(String... params) {
            String[] par = { mDestionationUri.toString()};
