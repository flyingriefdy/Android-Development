...
//        });
    ...
    YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onLoaded(String s) {
            Toast.makeText(YoutubeActivity.this,"Click the ad!",Toast.LENGTH_SHORT).show();
        }
        ...
        public void onError(YouTubePlayer.ErrorReason errorReason) {
            Toast.makeText(YoutubeActivity.this,"Error: !"+errorReason,Toast.LENGTH_SHORT).show();
        }
    };

    @Override
    public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
        Toast.makeText(this,"Failed to initialized Youtube Player successfully",Toast.LENGTH_SHORT).show();
    }
}
